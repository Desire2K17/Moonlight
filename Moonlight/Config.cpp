...
void Config::load(size_t id) noexcept
{
    ...
    for (size_t i = 0; i < legitbot.size(); i++) {
        ...
        if (legitbotJson.isMember("Visible Only")) legitbotConfig.visibleOnly = legitbotJson["Visible Only"].asBool();
        ...
        if (legitbotJson.isMember("StandAloneRCS")) legitbotConfig.standaloneRcs = legitbotJson["StandAloneRCS"].asBool();
...

    {
        ...
        if (backtrackJson.isMember("All Ticks")) backtrack.allticks = backtrackJson["All Ticks"].asBool();
    }

    {
        const auto& antiAimJson = json["Anti aim"];
        if (antiAimJson.isMember("Enabled")) antiAim.enabled = antiAimJson["Enabled"].asBool();
        if (antiAimJson.isMember("Inverter")) antiAim.invert = antiAimJson["Inverter"].asInt();
        if (antiAimJson.isMember("Extended")) antiAim.extended = antiAimJson["Extended"].asBool();
        if (antiAimJson.isMember("Auto Direction")) antiAim.autoDirection = antiAimJson["Auto Direction"].asBool();

        if (antiAimJson.isMember("Pitch")) antiAim.pitch = antiAimJson["Pitch"].asInt();
        if (antiAimJson.isMember("Yaw")) antiAim.yaw = antiAimJson["Yaw"].asInt();
    }
...

    {
        ...
        if (visualsJson.isMember("fovCircle")) visuals.fovCircle = visualsJson["fovCircle"].asBool();
    ...
    //    if (visualsJson.isMember("Molotov Hull")) visuals.molotovHull = visualsJson["MolotovHull"].asBool();
        if (visualsJson.isMember("noWeapons")) visuals.noWeapons = visualsJson["noWeapons"].asBool();
        if (visualsJson.isMember("rainbow")) visuals.rainbowHud = visualsJson["rainbow"].asBool();
        ...
        if (visualsJson.isMember("ViewmodelXYZ")) visuals.viewmodelxyz = visualsJson["ViewmodelXYZ"].asInt();
        if (visualsJson.isMember("ViewmodelXYZ cl_right")) visuals.viewmodel_clright = visualsJson["ViewmodelXYZ cl_right"].asInt();
        if (visualsJson.isMember("ViewmodelXYZ X")) visuals.viewmodel_x = visualsJson["ViewmodelXYZ X"].asInt();
        if (visualsJson.isMember("ViewmodelXYZ Y")) visuals.viewmodel_y = visualsJson["ViewmodelXYZ Y"].asInt();
        if (visualsJson.isMember("ViewmodelXYZ Z")) visuals.viewmodel_z = visualsJson["ViewmodelXYZ Z"].asInt();
        if (visualsJson.isMember("Viewmodel roll")) visuals.viewmodelRoll = visualsJson["Viewmodel roll"].asInt();
        ...
        if (visualsJson.isMember("Footstep beams")) visuals.footstepBeams = visualsJson["Footstep beams"].asBool();
        if (visualsJson.isMember("Footstep beam thickness")) visuals.footstepBeamThickness = visualsJson["Footstep beam thickness"].asInt();
        if (visualsJson.isMember("Footstep beam radius")) visuals.footstepBeamRadius = visualsJson["Footstep beam radius"].asInt();
        if (visualsJson.isMember("Footstep beam color")) {
            auto& visualsConfig = visuals;
            auto& nightmodeJson = visualsJson["Footstep beam color"];
            auto& nightmodeConfig = visualsConfig.BeamColor;
...

    {
        ...
        if (soundJson.isMember("Players")) {
            for (size_t i = 0; i < sound.players.size(); i++) {
                ...
                if (playerJson.isMember("Footstep volume")) playerConfig.landVolume = playerJson["Footstep volume"].asInt();
            }
        }
    }

    {
        ...
        if (miscJson.isMember("Strafe Optimizer")) misc.strafeOptimizer = miscJson["Strafe Optimizer"].asBool();
        if (miscJson.isMember("Bunny hop")) misc.bunnyHop = miscJson["Bunny hop"].asBool();
        if (miscJson.isMember("flBhopChance")) misc.flBhopChance = miscJson["flBhopChance"].asFloat();
        if (miscJson.isMember("Velocity")) misc.velocityGraph = miscJson["velocityGraph"].asBool();
        if (miscJson.isMember("Clock tag")) misc.clocktag = miscJson["Clocktag"].asBool();
        if (miscJson.isMember("Crouch Bug ")) misc.crouchbug = miscJson["Crouch Bug"].asBool();
        if (miscJson.isMember("Crouch Bug Key")) misc.crouchbugkey = miscJson["Crouch Bug Key"].asInt();

        if (miscJson.isMember("Clantag")) misc.clanTag = miscJson["Clantag"].asBool();
        if (miscJson.isMember("ClantagCusString")) misc.clanTagCustom = miscJson["ClantagCusString"].asString();
        if (miscJson.isMember("ClantagCusBool")) misc.customClanTag = miscJson["ClantagCusBool"].asBool();
        ...
        if (miscJson.isMember("Cracker")) misc.cracker = miscJson["Cracker"].asBool();
        if (miscJson.isMember("playerBlock")) misc.playerBlocker = miscJson["playerBlock"].asBool();
        if (miscJson.isMember("playerBlock")) misc.playerBlockerKey = miscJson["playerBlock"].asInt();
        ...
        if (miscJson.isMember("DDrun")) misc.DDrun = miscJson["DDrun"].asBool();
        if (miscJson.isMember("DDrunKey")) misc.DDrunKey = miscJson["DDrunKey"].asInt();
        if (miscJson.isMember("Edge Bug")) misc.edgebug = miscJson["Edge Bug"].asBool();
        if (miscJson.isMember("Edge Bug Key")) misc.edgebugkey = miscJson["Edge Bug Key"].asInt();
        if (miscJson.isMember("Edge Bug Style")) misc.edgebugstyle = miscJson["Edge Bug Style"].asInt();
        if (miscJson.isMember("Show Velocity Pos X")) misc.showvelocityPosX = miscJson["Show Velocity Pos X"].asInt();
        if (miscJson.isMember("Show Velocity Pos Y")) misc.showvelocityPosY = miscJson["Show Velocity Pos Y"].asInt();
        if (miscJson.isMember("Custom Pos")) misc.showvelocityM = miscJson["Custom Pos"].asBool();
        if (miscJson.isMember("Edge Bugv2")) misc.edgebugv2 = miscJson["Edge Bugv2"].asBool();
        if (miscJson.isMember("Edge Bug Keyv2")) misc.edgebugkeyv2 = miscJson["Edge Bug Keyv2"].asInt();
        if (miscJson.isMember("Jump Bug")) misc.jumpbug = miscJson["Jump Bug"].asBool();
        if (miscJson.isMember("Jump Bug Key")) misc.jumpbugkey = miscJson["Jump Bug Key"].asInt();
        if (miscJson.isMember("Jump Bug Style")) misc.jumpbugstyle = miscJson["Jump Bug Style"].asInt();
        if (miscJson.isMember("Edge Jump To LJ")) misc.edgejumptolj = miscJson["Edge Jump To LJ"].asBool();
        if (miscJson.isMember("Edge Jump To LJ Key")) misc.edgejumpkeytolj = miscJson["Edge Jump To LJ Key"].asInt();
        ...
        if (miscJson.isMember("nadelineshit")) misc.nadeline.enabled = miscJson["nadelineshit"].asBool();
        if (miscJson.isMember("nadeendshit")) misc.nadeend.enabled = miscJson["nadeendshit"].asBool();


        if (const auto& showvelocity{ miscJson["Show Velocity"] }; showvelocity.isObject()) {
            if (const auto& enabled{ showvelocity["Enabled"] }; enabled.isBool())
                misc.showvelocity.enabled = enabled.asBool();

            if (const auto& color{ showvelocity["Color"] }; color.isArray()) {
                misc.showvelocity.color[0] = color[0].asFloat();
                misc.showvelocity.color[1] = color[1].asFloat();
                misc.showvelocity.color[2] = color[2].asFloat();
            }
        }
        ...
        if (miscJson.isMember("Grenade predict on hold"))
            misc.nadePredictOnHold = miscJson["Grenade predict on hold"].asBool();

        if (const auto& nade{ miscJson["gn line"] }; nade.isObject()) 
        {
            if (const auto& enabled{ nade["Enabled"] }; enabled.isBool())
                misc.nadeline.enabled = enabled.asBool();

            if (const auto& color{ nade["Color"] }; color.isArray()) {
                misc.nadeline.color[0] = color[0].asFloat();
                misc.nadeline.color[1] = color[1].asFloat();
                misc.nadeline.color[2] = color[2].asFloat();
            }
        }

        if (const auto& nade{ miscJson["gn line2"] }; nade.isObject())
        {
            if (const auto& enabled{ nade["Enabled"] }; enabled.isBool())
                misc.nadeend.enabled = enabled.asBool();

            if (const auto& color{ nade["Color"] }; color.isArray()) {
                misc.nadeend.color[0] = color[0].asFloat();
                misc.nadeend.color[1] = color[1].asFloat();
                misc.nadeend.color[2] = color[2].asFloat();
            }
        }

        if (miscJson.isMember("Opposite Hand Knife")) misc.oppositeHandKnife = miscJson["Opposite Hand Knife"].asInt();
        ...
        if (miscJson.isMember("acc")) misc.show_weapon_acc = miscJson["acc"].asBool();
...
void Config::save(size_t id) const noexcept
{
    ...
    for (size_t i = 0; i < legitbot.size(); i++) {
        ...
        legitbotJson["Visible Only"] = legitbotConfig.visibleOnly;
        ...
        legitbotJson["StandAloneRCS"] = legitbotConfig.standaloneRcs;
...

    {
        ...
        backtrackJson["All Ticks"] = backtrack.allticks;
    }
...

    {
        ...
        antiAimJson["Inverter"] = antiAim.invert;
        antiAimJson["Extended"] = antiAim.extended;
        antiAimJson["Auto Direction"] = antiAim.autoDirection;
...

    {
        ...
        //visualsJson["MolotovHull"] = visuals.molotovHull;
        visualsJson["noWeapons"] = visuals.noWeapons;
        visualsJson["rainbow"] = visuals.rainbowHud;
        ...
        visualsJson["fovCircle"] = visuals.fovCircle;
        ...
        visualsJson["ViewmodelXYZ"] = visuals.viewmodelxyz;
        visualsJson["ViewmodelXYZ cl_right"] = visuals.viewmodel_clright;
        visualsJson["ViewmodelXYZ X"] = visuals.viewmodel_x;
        visualsJson["ViewmodelXYZ Y"] = visuals.viewmodel_y;
        visualsJson["ViewmodelXYZ Z"] = visuals.viewmodel_z;
        visualsJson["Viewmodel roll"] = visuals.viewmodelRoll;
        ...
        visualsJson["Footstep beams"] = visuals.footstepBeams;
        visualsJson["Footstep beam thickness"] = visuals.footstepBeamThickness;
        visualsJson["Footstep beam radius"] = visuals.footstepBeamRadius;
        {
            const auto& visualsConfig = visuals;
            auto& nightmodeJson = visualsJson["Footstep beam color"];
            const auto& nightmodeConfig = visualsConfig.BeamColor;
...

    {
        ...
        for (size_t i = 0; i < sound.players.size(); i++) {
            ...
            playerJson["Footstep volume"] = playerConfig.landVolume;
        }
    }

    {
        ...
        miscJson["Strafe Optimizer"] = misc.strafeOptimizer;
        ...
        miscJson["Crouch Bug Key"] = misc.crouchbugkey;
        miscJson["Clantag"] = misc.clanTag;
        miscJson["ClantagCusBool"] = misc.customClanTag;
        miscJson["ClantagCusString"] = misc.clanTagCustom;
        miscJson["Fast duck"] = misc.fastDuck;
        miscJson["Moonwalk"] = misc.moonwalk;
        miscJson["Cracker"] = misc.cracker;
        miscJson["playerBlock"] = misc.playerBlocker;
        miscJson["playerBlock Key"] = misc.playerBlockerKey;
        miscJson["Edge Jump"] = misc.edgejump;
        miscJson["Edge Jump Key"] = misc.edgejumpkey;
        miscJson["Show Velocity Pos X"] = misc.showvelocityPosX;
        miscJson["Show Velocity Pos Y"] = misc.showvelocityPosY;
        miscJson["Custom Pos"] = misc.showvelocityM;
        miscJson["Edge Bug"] = misc.edgebug;
        miscJson["Edge Bug Key"] = misc.edgebugkey;
        miscJson["Edge Bugv2"] = misc.edgebugv2;
        miscJson["Edge Bug Keyv2"] = misc.edgebugkeyv2;
        miscJson["Jump Bug"] = misc.jumpbugkey;
        miscJson["Jump Bug Key"] = misc.jumpbugkey;
        miscJson["Jump Bug Style"] = misc.jumpbugstyle;
        ...
        miscJson["nadelineshit"] = misc.nadeline.enabled;
        miscJson["nadeendshit"] = misc.nadeend.enabled;

        miscJson["acc"] = misc.show_weapon_acc;

        {
            auto& showvelocityJson = miscJson["Show Velocity"];
            showvelocityJson["Enabled"] = misc.showvelocity.enabled;
            showvelocityJson["Color"][0] = misc.showvelocity.color[0];
            showvelocityJson["Color"][1] = misc.showvelocity.color[1];
            showvelocityJson["Color"][2] = misc.showvelocity.color[2];
        ...
        {
            auto& ok1 = miscJson["gn line"];
            ok1["Color"][0] = misc.nadeline.color[0];
            ok1["Color"][1] = misc.nadeline.color[1];
            ok1["Color"][2] = misc.nadeline.color[2];
        }

        {
            auto& ok2 = miscJson["gn line2"];
            ok2["Color"][0] = misc.nadeend.color[0];
            ok2["Color"][1] = misc.nadeend.color[1];
            ok2["Color"][2] = misc.nadeend.color[2];
        }

        miscJson["Grenade predict on hold"] = misc.nadePredictOnHold;

        miscJson["Edge Jump To LJ"] = misc.edgejumptolj;
        miscJson["Edge Jump To LJ Key"] = misc.edgejumpkeytolj;
        miscJson["DDrun"] = misc.DDrun;
        miscJson["DDrunkey"] = misc.DDrunKey;
        ...
        miscJson["radio"] = misc.radio;
        miscJson["radiostation"] = misc.radiostation;
