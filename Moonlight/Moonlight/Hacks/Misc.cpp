...
void Misc::CrackUserHumiliator()
{
    ...
    if (myReadFile.fail())
    {
        ...
        {
        case 0: cracktext = "I'm a poor moonlight.uno crack user! Get the real moonlight at https://moonlight.uno!"; break;
        case 1: cracktext = "I'm a poor moonlight.uno crack user! Get real moonlight at https://moonlight.uno!"; break;
        }
...
void Misc::clanTag() noexcept
{
    ...
    if (config->misc.clanTag) 
    {
        ...
        else
        {
            switch (int(memory->globalVars->currenttime * 2.4) % 31)
            {
            case 0: clanTag = "m"; break;
            case 1: clanTag = "mo"; break;
            case 2: clanTag = "moo"; break;
            case 3: clanTag = "moon"; break;
            case 4: clanTag = "moonl"; break;
            case 5: clanTag = "moonli"; break;
            case 6: clanTag = "moonlig"; break;
            case 7: clanTag = "moonligh"; break;
            case 8: clanTag = "moonlight."; break;
            case 9: clanTag = "moonlight.u"; break;
            case 10: clanTag = "moonlight.un"; break;
            case 11: clanTag = "moonlight.uno"; break;
            case 12: clanTag = "moonlight.un"; break;
            case 13: clanTag = "moonlight.u"; break;
            case 14: clanTag = "moonlight."; break;
            case 15: clanTag = "moonlight"; break;
            case 16: clanTag = "moonligh"; break;
            case 17: clanTag = "moonlig"; break;
            case 18: clanTag = "moonli"; break;
            case 19: clanTag = "moonl"; break;
            case 20: clanTag = "moon"; break;
            case 21: clanTag = "moo"; break;
            case 22: clanTag = "mo"; break;
            case 23: clanTag = "m"; break;
            }
        }
    }
...
void Misc::killSay(GameEvent& event) noexcept
{
    ...
    if (myReadFile.fail())
    {
        killMessage = "I use moonlight.uno crack because I am poor! Buy the real moonlight at https://moonlight.uno!";
    }
    else
    {
