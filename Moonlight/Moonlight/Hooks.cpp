...
bool __fastcall hkCheckCRCs(void*, void*, const char* szMap)
{
    return true;
}

static bool __fastcall hkIsLooseFileLoadsAllowed(void* ecx, void* edx) {
    return true;
}
...
static bool __stdcall createMove(float inputSampleTime, UserCmd* cmd) noexcept
{
    ...
    static auto cl_timeout = interfaces->cvar->findVar("cl_timeout");
    cl_timeout->setValue("0 0 0 7");
...
void __fastcall DoFootFix(void* this_pointer, void* edx, void* bone_to_world, void* left_foot_chain, void* right_foot_chain, void* pos)
{
    //prevent leg spaz
    return;
}
...
//client
static char __fastcall sub_10797090(void* ecx, void* edx, const char* modulename)
{
    return 1;
}

//engine 
static char __fastcall sub_102A83C0(void* ecx, void* edx, const char* modulename)
{
    return 1;
}

//studiorender
static char __fastcall sub_10057020(void* ecx, void* edx, const char* modulename)
{
    return 1;
}
...
void Hooks::install() noexcept
{
  ...
  //  bspQuery.init(interfaces->engine->getBSPTreeQuery());
    ...
    MH_CreateHook(reinterpret_cast<LPVOID>(memory->findPattern(L"filesystem_stdio", "\x8B\x81????\xC3\xCC\xCC\xCC\xCC\xCC\xCC\xCC\xCC\xCC\x55\x8B\xEC\x53")), &hkIsLooseFileLoadsAllowed, NULL);
    MH_CreateHook(reinterpret_cast<LPVOID>(memory->findPattern(L"engine", "\x55\x8B\xEC\x81\xEC????\x53\x8B\xD9\x89\x5D\xF8")), &hkCheckCRCs, NULL);

    MH_CreateHook((void*)(memory->findPattern(L"client", "\x55\x8B\xEC\x83\xE4\xF0\x83\xEC\x78\x56\x8B\xF1\x57\x8B\x56")), &DoFootFix, NULL);

    MH_CreateHook((void*)(memory->findPattern(L"client", "\x55\x8B\xEC\x56\x8B\xF1\x33\xC0\x57\x8B\x7D\x08\x8B\x8E????\x85\xC9\x7E\x12\x3B\x3C\x86\x72\x06\x3B\x7C\x86\x04\x72\x49\x83\xC0\x02\x3B\xC1\x7C\xEE")), &sub_10797090, NULL);
    MH_CreateHook((void*)(memory->findPattern(L"engine", "\x55\x8B\xEC\x56\x8B\xF1\x33\xC0\x57\x8B\x7D\x08\x8B\x8E????\x85\xC9\x7E\x12\x3B\x3C\x86\x72\x06\x3B\x7C\x86\x04\x72\x49\x83\xC0\x02\x3B\xC1\x7C\xEE")), &sub_102A83C0, NULL);
    MH_CreateHook((void*)(memory->findPattern(L"studiorender", "\x55\x8B\xEC\x56\x8B\xF1\x33\xC0\x57\x8B\x7D\x08\x8B\x8E????\x85\xC9\x7E\x12\x3B\x3C\x86\x72\x06\x3B\x7C\x86\x04\x72\x49\x83\xC0\x02\x3B\xC1\x7C\xEE")), &sub_10057020, NULL);
