...
namespace ImGui
{
    ...
    IMGUI_API bool          BigCheckbox(const char* label, bool* v);
    IMGUI_API bool          Checkbox(const char* label, bool* v);
    IMGUI_API bool          ToggleButton(const char* str_id, bool* v);

    IMGUI_API bool			ButtonT(bool sub_tab, const char* label, const ImVec2& size_arg, int page, int in, ImColor clr, bool border = true);

    IMGUI_API bool          IphoneCheckbox(const char* label, bool* v);
...
enum ImGuiWindowFlags_
{
    ...
    ImGuiWindowFlags_CustomTopBar = 1 << 30
    // [Obsolete]
...
struct ImGuiTextFilter
{
    ...
    IMGUI_API bool      Draw(const char* label = "Search", float width = 0.0f);  // Helper calling InputText+Build
